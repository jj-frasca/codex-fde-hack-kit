...
3. Set persistent goals.
4. Define guardrails.
5. Use specialist boards for discovery, architecture/slice, implementation review, and demo trust.
6. Use Codex for repo triage.
7. Use Codex for implementation through one main integrator.
8. Use subagents/review threads for focused read-heavy review, test/log triage, and risk checks.
9. Verify outputs through tests, smoke runs, fixtures, or manual checklists.
10. Summarize diffs.
11. Convert output into a client-trust demo.
